...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/draft1a.pt', help='model path(s)')
    parser.add_argument('--source', type=str, default=3, help='file/dir/URL/glob, 0 for webcam')
